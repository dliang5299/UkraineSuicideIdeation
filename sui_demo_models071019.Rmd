...
# full demographics
ideate_demo_glm <-
  svyglm(ideate~brom3_agecohort+SEX+io16+de34+marital_status+de20+emp+financial_status+SN7,
         family = quasibinomial("logit"), design = SuicidePart2)
summary(ideate_demo_glm)
```
...
# full demographics
plan_demo_glm <-
  svyglm(plan~brom3_agecohort+SEX+io16+de34+marital_status+de20+emp+financial_status+SN7,
         family = quasibinomial("logit"), design = ideatedesign)
summary(plan_demo_glm)
```
...
# full demographics
attempt_demo_glm <-
  svyglm(attempt~brom3_agecohort+SEX+io16+de34+marital_status+de20+emp+financial_status+SN7,
         family = quasibinomial("logit"), design = ideatedesign)
summary(attempt_demo_glm)
```

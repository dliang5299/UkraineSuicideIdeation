...
cididata_pt2 <-
  ...
  # chronic conditions
  mutate(any_cc = ifelse(cc1a == 1|cc1b == 1|cc1c == 1|cc1d == 1|cc1e == 1|
  ...
  select(sampleid, brom4_agecohort, brom3_agecohort, alfonso_cohort, SEX, io16, 
         ...
         live_chernobyl, married, sc3, mr16, mr18, mr22, sn1, sn2, sn6, sn7, 
         SN1, SN2, SN6, SN7, cc1tz, cc2, cn6, cn6a,ideate, plan, attempt, ch67, 

...
svyglm(ideate~brom3_agecohort+SEX+io16+de20+financial_status+de32_1+de32_2+
         de32_other+de32_9+emp+marital_status,
...
```{r}
# ideate
svyglm(ideate~brom3_agecohort+SEX+io16+de20+financial_status+marital_status,
         family = quasibinomial("logit"), design = SuicidePart2) %>%
  summary()
# plan
svyglm(ideate~brom3_agecohort+SEX+io16+de20+financial_status+marital_status,
...
```{r}
# ideate
svyglm(ideate~brom3_agecohort+SEX+io16+de20+marital_status,
         family = quasibinomial("logit"), design = SuicidePart2) %>%
  summary()
# plan
svyglm(ideate~brom3_agecohort+SEX+io16+de20+marital_status,
